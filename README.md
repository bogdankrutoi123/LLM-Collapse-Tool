...
Демонстрация работы алертинга при вычислении бенчмарков и сравнение двух версий одной модели. Модели уже загружены (пара версий из симуляции коллапса), некоторые правила алертинга уже поставлены (`some_rule`, `some_rule_2` и пороговое правило на ненулевую энтропию для иллюстрации уведомлений).

https://github.com/user-attachments/assets/2c048b62-fac2-493d-9ebf-d57484a3e81d
